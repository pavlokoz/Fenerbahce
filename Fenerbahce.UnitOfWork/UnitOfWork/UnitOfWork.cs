...
namespace Fenerbahce.UnitOfWork.UnitOfWork
{
	public class UnitOfWork : IUnitOfWork
	{
		...
		private IRepository<EventEntity> eventRepository;
		...
		public IRepository<EventEntity> EventRepository => eventRepository ??
			(eventRepository = new Repository<EventEntity>(Context));
